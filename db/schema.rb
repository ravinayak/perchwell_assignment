...
ActiveRecord::Schema.define(version: 20_240_903_173_962) do
  ...
  create_table 'building_custom_fields', force: :cascade do |t|
    ...
    t.index %w[building_id custom_field_id],
            name: 'index_building_custom_fields_on_building_id_and_custom_field_id', unique: true
